...
<p>Hello <a href="settings.jsp"><%=session.getAttribute("user")%></a></p>
<a href="logout.jsp">
						<span>
						Logout
						</span>
...
<form action="change password action.jsp" method="post">
<table>

<tr><td>New password:</td><td><input type="text" name="new"></td></tr>
<tr><td>Confirm New Password:</td><td><input type="text" name="confirm"></td></tr>
