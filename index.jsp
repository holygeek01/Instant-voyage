...
<html>
<head>
<title>Instant voyage|Home</title>
...
function validate(form1)
{
  for (i = 0; i < form1.length; i++){
       ...
       if( (form1.elements[i].value == "")  ){
           alert("You must provide a value for the field named: " + 
...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="header-grids">
				<div class="logo">
					<h1>
						<a href="index.html"><span>Instant</span>Voyage</a>
					</h1>
				</div>
				<!--navbar-header-->
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li><a href="hotels.jsp">Hotels</a>
						</li>
						<li><a href="holidays.jsp">Holidays</a>
						</li>
						<li><a href="bus.jsp">About Us</a>
						</li>
						<li><a href="trains.jsp">Contact Us</a>
						</li>
    ...
    Hello   <p><a href="settings.jsp"><%out.println(session.getAttribute("user"));%></a></p>
...
<%     } %>
						...
						<div id="loginBox">
							<form id="loginForm" name="form2"
								action="LoginServlet"method="post" onsubmit="validate(form2)">
											...
											<div class="b_room">
												<div class="booking_room">
													<div class="reservation">
														<ul>
															<li class="span1_of_1 desti">
																<h5>Flying from</h5>
																<div class="book_date">
																	<form name="form1" onsubmit="validate(form1)">
													...
													<div class="reservation">
														...
														<br>	<li class="span1_of_1 economy">
			...
			<div class="footer-top-grids">
				<div class="footer-grids">
					<div class="col-md-3 footer-grid">
						<h4>Our Products</h4>
						<ul>
							<li><a href="index.html">Flight Schedule</a>
							</li>
							<li><a href="flights-hotels.html">City Airline Routes</a>
							</li>
							<li><a href="index.html">International Flights</a>
							</li>
							<li><a href="hotels.html">International Hotels</a>
							</li>
							<li><a href="bus.html">Bus Booking</a>
							</li>
							<li><a href="index.html">Domestic Airlines</a>
							</li>
							<li><a href="holidays.html">Holidays Trip</a>
							</li>
							<li><a href="hotels.html">Hotel Booking</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3 footer-grid">
						...
						<ul>
							...
							<li><a href="booking.html">Feedback</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3 footer-grid">
						...
						<ul>
							<li><a href="holidays.html">Holidays Packages</a>
							</li>
							<li><a href="weekend.html">Weekend Getaways</a>
							</li>
							<li><a href="index.html">International Airports</a>
							</li>
							<li><a href="index.html">Domestic Flights Booking</a>
							</li>
							<li><a href="booking.html">Customer Support</a>
							</li>
							<li><a href="booking.html">Cancel Bookings</a>
							</li>
							<li><a href="booking.html">Print E-tickets</a>
							</li>
							<li><a href="booking.html">Customer Forums</a>
							</li>
							<li><a href="booking.html">Make a Payment</a>
							</li>
							<li><a href="booking.html">Complete Booking</a>
							</li>
							<li><a href="booking.html">Assurance Claim</a>
							</li>
							<li><a href="booking.html">Retail Offices</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3 footer-grid">
						...
						<ul class="chf_footer_list">
											...
											<li><a href="https://book.goindigo.in/">Indigo Airlines</a>
							</li>
							<li><a href="http://www.airasia.com">Air Asia</a>
							</li>
							<li><a href="http://www.jetairways.com/EN/IN/Home.aspx">Jet Airways</a>
							</li>
							<li><a href="http://www.spicejet.com/">SpiceJet</a>
							</li>
							<li><a href="https://www.goair.in/">GoAir</a>
							</li>
							<li><a href="http://www.airindia.in/">Air India</a>
							</li>
						</ul>
					</div>
					<div class="clearfix"></div>
		...
		<div class="container">
			<div class="footer-bottom-top-grids">
				<div class="col-md-4 footer-bottom-left">
					...
					<div class="d-apps">
						<ul>
							<li><a href="#"><img src="images/app1.png" alt="" />
							</a>
							</li>
							<li><a href="#"><img src="images/app2.png" alt="" />
							</a></a>
							</li>
							<li><a href="#"><img src="images/app3.png" alt="" />
							</a></a>
							</li>
						</ul>
					</div>
				...
				<div class="col-md-4 footer-bottom-left">
					...
					<div class="a-cards">
						<ul>
							<li><a href="#"><img src="images/c1.png" alt="" />
							</a>
							</li>
							<li><a href="#"><img src="images/c2.png" alt="" />
							</a></a>
							</li>
							<li><a href="#"><img src="images/c3.png" alt="" />
							</a></a>
							</li>
						</ul>
					</div>
				...
				<div class="copyright">
					<p>
						Copyrights � 2015 Instant Voyage  
					</p>
				</div>
			</div>
		</div>
