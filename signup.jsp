...
<html>
<head>
<title>Instant Voyage|Sign Up</title>
<!-- Custom Theme files -->
					...
					<div class="col-md-6 book-left">
						...
						<div class="book-left-form">
							<form action="register.jsp"  method="post">
								...
								<p>First Name</p>
								<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}" name="firstname">
								<p>Last Name</p>
								<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}" name="lastname">
								
							    <p>Phone Number</p>
								<input type="text" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}" name="phonenumber">
								<p>Email Address</p>
								<input type="email" value="" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='';}" name="emailid">
								<p>Password</p>
								<input type="password" name="password" id="password" name="password">
								<p>Confirm Password</p>
								<input type="password" name="confirmpassword" id="password" name="confirmpassword">
				...
				<div class="footer-grids">
					...
					<div class="col-md-3 footer-grid">
						...
						<ul>
							...
							<li><a href="weekend.html">Weekend Getaways</a></li>
							<li><a href="index.jsp">International Airports</a></li>
							<li><a href="index.jsp">Domestic Flights Booking</a></li>
